...
# Overwrite the variables.yaml file
cp "$SCRIPT_DIR/azure-enterprise-scale-ml/environment_setup/aifactory/bicep/copy_to_local_settings/azure-devops/esml-yaml-pipelines/variables/variables.yaml" "$SCRIPT_DIR/aifactory-templates/esml-infra/azure-devops/yaml/variables/variables.yaml"

# Copy the YAML files:esml-infra-common, esml-infra-project etc
