...
while (( $# )); do
  ...
  case "$argument" in
    ...
    --help|-h)
      ...
      printf '  Omitted version defaults normal Update to 124; project-only keeps installed code.\n'
...
version_default=""
[[ "$project_only" == "true" ]] || version_default="${AIF_UPDATE_DEFAULT_VERSION:-124}"
