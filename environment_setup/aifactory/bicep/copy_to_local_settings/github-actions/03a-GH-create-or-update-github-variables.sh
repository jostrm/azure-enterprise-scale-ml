...
repo_level_vars=(
  ...
  # === PER-ENVIRONMENT SERVICE SKUs (Dev vs Stage/Prod) ===
  # Consumed by infra-project.yml as vars.SKU_<SERVICE>_DEV / vars.SKU_<SERVICE>_STAGEPROD.
  # Core Infrastructure (02)
  "SKU_STORAGEACCOUNT_DEV"
  "SKU_STORAGEACCOUNT_STAGEPROD"
  # Cognitive Services (03)
  "SKU_AISERVICES_DEV"
...
for env in "${selected_environments[@]}"; do
    ...
    create_or_update_secret $env "KONG_CONSUMER_API_KEY" "$KONG_CONSUMER_API_KEY"
