...
// Subscription-scoped cost budget. When actual OR forecasted spend crosses the
// threshold, it notifies the Action Group (which triggers the throttle Logic App).
// =============================================================================
...
@description('Budget start date (first of a month), format yyyy-MM-dd. Must be first of month.')
