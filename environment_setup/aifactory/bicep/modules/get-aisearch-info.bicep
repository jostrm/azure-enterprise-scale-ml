...
output principalId string = aiSearchExists ? reference(resourceId('Microsoft.Search/searchServices', aiSearchName), '2024-06-01-preview', 'Full').identity.principalId : ''

@description('AI Search service name')
output name string = aiSearchName

@description('AI Search exists flag')
output exists bool = aiSearchExists
