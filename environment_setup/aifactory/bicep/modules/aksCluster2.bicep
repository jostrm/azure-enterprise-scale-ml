// BICEP 2 Purpose - custom Private DNS zones: https://learn.microsoft.com/en-us/azure/aks/private-clusters?tabs=azure-portal
...
// PARAMS - UserAssignedIdentity and Private Cluster with 
    ...
    privateLinkResources: [
      {
        groupId: 'aks'
        requiredMembers: 1
        privateDnsZoneId: '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Network/privateDnsZones/{private-dns-zone-name}'
      }
    ]
    addonProfiles: {
      azurePolicy: {
