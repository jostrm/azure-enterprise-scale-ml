...
var aifV2ProjectName = addAIFoundry? aifpRandom: namingConvention.outputs.aifV2PrjName // aif2pqoygyc7
...
module roleAssignmentsBuilder '../modules/csFoundry/buildRoleAssignments.bicep' = if(enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
...
#disable-next-line BCP318
var aiFoundryRoleAssignments = (enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry)) ? roleAssignmentsBuilder.outputs.roleAssignments : []
...
//var requiresAcaDelegation = (!containerAppsEnvExists) && enableAIFoundry && !aiFoundryV2Exists && !disableAgentNetworkInjection && !foundryV22AccountOnly
...
var deployAvmFoundry = useAVMFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry)
var shouldDeployFoundryPrivateEndpoints = !foundryV22AccountOnly && (enableAIFoundry || enableAIFoundryV22) // ensures PE creation for full V21/V22 builds

module aiFoundry2025NoAvmV22AccountOnly '../modules/csFoundry/aiFoundry2025AvmOffApimAccount.bicep' = if(foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module aiFoundry2025NoAvmV22 '../modules/csFoundry/aiFoundry2025AvmOffApim.bicep' = if(!foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module aiFoundry2025NoAvm '../modules/csFoundry/aiFoundry2025AvmOff.bicep' = if(!enableAIFoundryV22 && !deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module aiFoundry2025Avm '../modules/csFoundry/aiFoundry2025AvmOn.bicep' = if(deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
resource aiFoundryAccountAvm 'Microsoft.CognitiveServices/accounts@2025-07-01-preview' existing = if(deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry)) {
  name: aifV2Name
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
}
...
var aiFoundrySystemAssignedPrincipalId = deployAvmFoundry
  ...
  : (enableAIFoundryV22
      ...
      : (enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry)
...
module projectV21 '../modules/csFoundry/aiFoundry2025project.bicep' = if(projectModuleEnabled && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
// Legacy condition reference: !enablePublicAccessWithPerimeter && !deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly
module aiFoundryPrivateEndpoints '../modules/csFoundry/aiFoundry2025pend.bicep' = if(!enablePublicAccessWithPerimeter && !deployAvmFoundry && shouldDeployFoundryPrivateEndpoints && (!aiFoundryV2Exists || updateAIFoundry)) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
#disable-next-line BCP318
var projectPrincipal = (projectModuleEnabled && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) ? projectV21.outputs.projectPrincipalId : ''
#disable-next-line BCP318
var projectWorkspaceId = (projectModuleEnabled && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) ? projectV21.outputs.projectWorkspaceId : ''
...
module assignCognitiveServicesRoles '../modules/csFoundry/aiFoundry2025rbac.bicep' = if(projectModuleEnabled && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !aiFoundryV2Exists && !foundryV22AccountOnly) {
...
module rbacPreCaphost '../modules/csFoundry/aiFoundry2025caphostRbac1.bicep' = if(enableCaphost && enableAIFactoryCreatedDefaultProjectForAIFv2 && enableAISearch && enableCosmosDB && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module rbacAISearchForAIFv21 '../modules/csFoundry/rbacAISearchForAIFv2.bicep' = if(enableAISearch && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module addProjectCapabilityHost '../modules/csFoundry/aiFoundry2025caphost.bicep' = if(enableCaphost && enableAIFactoryCreatedDefaultProjectForAIFv2 && enableAISearch && enableCosmosDB && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module formatProjectWorkspaceId '../modules/formatWorkspaceId2Guid.bicep' = if(enableCaphost && enableAIFactoryCreatedDefaultProjectForAIFv2 && enableAISearch && enableCosmosDB && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module rbacPostCaphost '../modules/csFoundry/aiFoundry2025caphostRbac2.bicep' = if(enableCaphost && enableAIFactoryCreatedDefaultProjectForAIFv2 && enableAISearch && enableCosmosDB && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
...
module rbacKeyVaultForAgents '../modules/csFoundry/rbacKeyVaultForAgents.bicep' = if(enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
module rbacProjectKeyVaultForAIFoundry '../modules/kvRbacAIFoundryMI.bicep' = if(enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) {
  scope: resourceGroup(subscriptionIdDevTestProd, targetResourceGroup)
...
var aiFoundryResourceIdAvm = (deployAvmFoundry && !foundryV22AccountOnly)
  ...
  : ''
#disable-next-line BCP318
var aiFoundryAccountNameLegacy = (!enableAIFoundryV22 && !deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) ? aiFoundry2025NoAvm!.outputs.name : '' 
#disable-next-line BCP318
var aiFoundryAccountNameV22 = (!foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) ? aiFoundry2025NoAvmV22!.outputs.aiAccountName : ''
#disable-next-line BCP318
var aiFoundryAccountNameV22AccountOnly = (foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) ? aiFoundry2025NoAvmV22AccountOnly!.outputs.aiAccountName : ''
...
#disable-next-line BCP318
var aiFoundryResourceIdLegacy = (!enableAIFoundryV22 && !deployAvmFoundry && enableAIFoundry && (!aiFoundryV2Exists || updateAIFoundry) && !foundryV22AccountOnly) ? aiFoundry2025NoAvm!.outputs.resourceId : ''
#disable-next-line BCP318
var aiFoundryResourceIdV22 = (!foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) ? aiFoundry2025NoAvmV22!.outputs.aiAccountId : ''
#disable-next-line BCP318
var aiFoundryResourceIdV22AccountOnly = (foundryV22AccountOnly && enableAIFoundryV22 && !useAVMFoundry && (!aiFoundryV2Exists || updateAIFoundry)) ? aiFoundry2025NoAvmV22AccountOnly!.outputs.aiAccountId : ''
...
var enableSharedLinkDeployment = enableAISearchSharedPrivateLink && enableAISearch && (enableAIFoundry || enableAIFoundryV22)
...
output aiFoundryV2Deployed bool = enableAIFoundry || enableAIFoundryV22

@description('AI Foundry V2 name')
output aiFoundryV2Name string = (enableAIFoundry || enableAIFoundryV22) ? aiFoundryAccountNameOutput : ''

@description('AI Foundry V2 resource ID')
output aiFoundryV2ResourceId string = (enableAIFoundry || enableAIFoundryV22) ? aiFoundryResourceIdOutput : ''

@description('AI Foundry Project deployment status')
output aiFoundryProjectDeployed bool = enableAIFoundryV22
  ? (foundryV22AccountOnly ? false : aiFoundry2025NoAvmV22!.outputs.aiFoundryProjectDeployed)
