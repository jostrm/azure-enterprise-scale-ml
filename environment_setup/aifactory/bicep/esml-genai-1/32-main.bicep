...
#disable-next-line BCP318
var var_aca_env_name = resourceExists.containerAppsEnv && serviceSettingDeployContainerApps? containerAppsEnvName : serviceSettingDeployContainerApps? containerAppsEnv.outputs.environmentName: ''
#disable-next-line BCP318
var var_aca_env_id = resourceExists.containerAppsEnv && serviceSettingDeployContainerApps?containerAppsEnvREF.id: serviceSettingDeployContainerApps? containerAppsEnv.outputs.environmentId: ''
#disable-next-line BCP318
...
// Endpoint vars
#disable-next-line BCP318
var var_openAIEndpoint = (!resourceExists.openai && serviceSettingDeployAzureOpenAI)? csAzureOpenAI.outputs.azureOpenAIEndpoint: serviceSettingDeployAzureOpenAI? openaiREF.properties.endpoint: ''
#disable-next-line BCP318
var var_aiServicesOpenAIEndpoint = (!resourceExists.aiServices && enableAIServices)? aiServices.outputs.openAIEndpoint: enableAIServices? aiServicesREF.properties.endpoint: ''
#disable-next-line BCP318
var var_aiservices_openai_endpoint = resourceExists.aiServices && enableAIServices? aiServicesREF.properties.endpoints['OpenAI Language Model Instance API'] : enableAIServices? aiServices.outputs.openAIEndpoint: ''

var hostname = 'https://${safeNameAISearch}.search.windows.net'
#disable-next-line BCP318
var var_aisearch_endpoint = (!resourceExists.aiSearch && enableAISearch)? aiSearchService.outputs.aiSearchEndpoint: enableAISearch? hostname: ''
#disable-next-line BCP318
var var_appinsights_connectionstring= !resourceExists.applicationInsight && serviceSettingDeployAppInsightsDashboard ?appinsights.outputs.connectionString:serviceSettingDeployAppInsightsDashboard? appInsightsREF.properties.ConnectionString: ''
#disable-next-line BCP318
var var_bingName=(serviceSettingDeployBingSearch && !resourceExists.bing)? bing.outputs.bingName:serviceSettingDeployBingSearch? bingName: ''

var var_bing_endpoint=(serviceSettingDeployBingSearch)? 'https://api.bing.microsoft.com/':''
#disable-next-line BCP318 BCP422
var var_bing_api_Key=(serviceSettingDeployBingSearch && !resourceExists.bing)? bing.outputs.bingApiKey: serviceSettingDeployBingSearch && resourceExists.bing? bingREF.listKeys().key1:''
#disable-next-line BCP318
...
// Service Names vars
#disable-next-line BCP318
var var_cosmosdb_name = cosmosdb.outputs.name
#disable-next-line BCP318
var var_postgreSQL_name = postgreSQL.outputs.name
#disable-next-line BCP318
var var_redisCache_name = redisCache.outputs.name
#disable-next-line BCP318
var var_sqlServer_serverName = sqlServer.outputs.serverName
#disable-next-line BCP318
var var_acrCommon2_containerRegistryName = acrCommon2.outputs.containerRegistryName
#disable-next-line BCP318
var var_acr_containerRegistryName = acr.outputs.containerRegistryName
#disable-next-line BCP318
var var_applicationInsightSWC_name = applicationInsightSWC.outputs.name
#disable-next-line BCP318
var var_csVision_name = csVision.outputs.name
#disable-next-line BCP318
var var_csSpeech_name = csSpeech.outputs.name
#disable-next-line BCP318
var var_csDocIntelligence_name = csDocIntelligence.outputs.name
#disable-next-line BCP318
var var_aiHub_name = enableAIFoundryHub? (resourceExists.aiHub? aiHubName:aiHub.outputs.name): ''

// Additional output vars for modules
#disable-next-line BCP318
var var_webapp_principalId = resourceExists.webApp? webappREF.identity.principalId: webapp.outputs.principalId
#disable-next-line BCP318
var var_acaApi_SERVICE_ACA_URI = acaApi.outputs.SERVICE_ACA_URI
#disable-next-line BCP318
var var_projectResourceGroup_rgId = projectResourceGroup.outputs.rgId

// Principal ID vars for cognitive services
#disable-next-line BCP318
var var_csVision_principalId = csVision.outputs.principalId
#disable-next-line BCP318
...
module postgreSQLRbac '../modules/databases/postgreSQL/pgFlexibleServerRbac.bicep' = if(!resourceExists.postgreSQL && serviceSettingDeployPostgreSQL){
  ...
  params: {
    #disable-next-line BCP318
    postgreSqlServerName: var_postgreSQL_name
    useAdGroups: useAdGroups
    usersOrAdGroupArray: p011_genai_team_lead_array
    servicePrincipleAndMIArray: spAndMiArray
...
module sqlRbac '../modules/databases/sqldatabase/sqldatabaseRbac.bicep' = if(!resourceExists.sqlServer && serviceSettingDeploySQLDatabase) {
  ...
  params: {
    #disable-next-line BCP318
    sqlServerName: var_sqlServer_serverName
    useAdGroups: useAdGroups
    usersOrAdGroupArray: p011_genai_team_lead_array
    servicePrincipleAndMIArray: spAndMiArray
...
module miRbac '../modules/miRbac.bicep'  = if(!resourceExists.miACA && useCommonACR) {
  ...
  params: {
    #disable-next-line BCP318
    containerRegistryName: var_acrCommon2_containerRegistryName
...
module miRbacProj '../modules/miRbac.bicep'  = if(!resourceExists.miACA && !useCommonACR) {
  ...
  params: {
    #disable-next-line BCP318
    containerRegistryName: var_acr_containerRegistryName
    principalId: var_miAca_PrincipalId
  }
  dependsOn: [
    projectResourceGroup
...
module rbacForWebAppMSI '../modules/webappRbac.bicep' = if(!resourceExists.webApp && serviceSettingDeployWebApp) {
  ...
  params: {
    ...
    #disable-next-line BCP318
    webAppPrincipalId: var_webapp_principalId //var_webAppPrincipalId
...
module acaWebApp '../modules/containerappWeb.bicep' = if(!resourceExists.containerAppW && serviceSettingDeployContainerApps) {
  ...
  params: {
    ...
    #disable-next-line BCP318
    apiEndpoint: var_acaApi_SERVICE_ACA_URI // TODO: MayTheForceBeWithYou - as var and REF.
    allowedOrigins: allowedOrigins
    containerAppsEnvironmentName: var_aca_env_name
    containerAppsEnvironmentId: var_aca_env_id
    containerRegistryName: var_acr_cmn_or_prj
...
module rbacForContainerAppsMI '../modules/containerappRbac.bicep' = if (!resourceExists.miACA && serviceSettingDeployContainerApps) {
  ...
  params:{
    ...
    #disable-next-line BCP318
    resourceGroupId: var_projectResourceGroup_rgId
  }
  dependsOn: [
    projectResourceGroup
...
module amlv2 '../modules/machineLearningv2.bicep'= if(!resourceExists.aml && enableAzureMachineLearning) {
  ...
  params: {
    ...
    #disable-next-line BCP318
    appInsightsName: var_applicationInsightSWC_name
  }
  dependsOn: [
    projectResourceGroup
    ...(resourceExists.storageAccount2001 ? [] : [sa4AIsearch])
...
module aiHub '../modules/machineLearningAIHub.bicep' = if(!resourceExists.aiHub && enableAIFoundryHub) {
  ...
  params: {
    ...
    aifactorySuffix: aifactorySuffixRG
    #disable-next-line BCP318
    applicationInsightsName: resourceExists.applicationInsight? applicationInsightName: var_applicationInsightSWC_name
    acrName: var_acr_cmn_or_prj
    acrRGName: useCommonACR? commonResourceGroup: targetResourceGroup
    env: env
    keyVaultName: var_kv1_name
...
module rbacAcrProjectspecific '../modules/acrRbac.bicep' = if(useCommonACR == false && enableAIFoundryHub) {
  ...
  params: {
    #disable-next-line BCP318
    acrName: resourceExists.acrProject? acrProjectName: var_acr_containerRegistryName
    #disable-next-line BCP318
    aiHubName: var_aiHub_name
...
module rbacVision '../modules/aihubRbacVision.bicep' = if(serviceSettingDeployAzureAIVision==true) {
  ...
  params:{
    ...
    storageAccountName2:var_storageAccountName2
    #disable-next-line BCP318
    aiVisionMIObjectId: var_csVision_principalId
    userObjectIds: p011_genai_team_lead_array
    #disable-next-line BCP318
    visonServiceName: var_csVision_name
    useAdGroups:useAdGroups
    servicePrincipleAndMIArray: spAndMiArray
  }
  dependsOn: [
...
module rbacSpeech '../modules/aihubRbacSpeech.bicep' = if(serviceSettingDeployAzureSpeech==true) {
  ...
  params:{
    ...
    storageAccountName2:var_storageAccountName2
    #disable-next-line BCP318
    aiSpeechMIObjectId: var_csSpeech_principalId
    userObjectIds: p011_genai_team_lead_array
    #disable-next-line BCP318
    speechServiceName: var_csSpeech_name
    useAdGroups:useAdGroups
    servicePrincipleAndMIArray: spAndMiArray
  }
  dependsOn: [
...
module rbacDocs '../modules/aihubRbacDoc.bicep' = if(serviceSettingDeployAIDocIntelligence==true) {
  ...
  params:{
    ...
    userObjectIds: p011_genai_team_lead_array
    #disable-next-line BCP318
    aiDocsIntelMIObjectId: var_csDocIntelligence_principalId
    #disable-next-line BCP318
    docsServiceName: var_csDocIntelligence_name
    useAdGroups:useAdGroups
    servicePrincipleAndMIArray: spAndMiArray
  }
  dependsOn: [
