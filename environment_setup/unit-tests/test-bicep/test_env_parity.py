...
ALIASES = {
    ...
    # Per-environment service SKUs (Dev vs Stage/Prod). ADO uses camelCase
    # sku<Service>Dev/StageProd; GitHub uses SKU_<SERVICE>_DEV/STAGEPROD.
    "skuTierAksDev": "SKU_TIER_AKS_DEV",
    "skuTierAksStageProd": "SKU_TIER_AKS_STAGEPROD",
    "skuAksDev": "SKU_AKS_DEV",
    "skuAksStageProd": "SKU_AKS_STAGEPROD",
    "skuStorageAccountDev": "SKU_STORAGEACCOUNT_DEV",
    "skuStorageAccountStageProd": "SKU_STORAGEACCOUNT_STAGEPROD",
    ...
    "skuOpenAIStageProd": "SKU_OPENAI_STAGEPROD",
    "skuContentSafetyDev": "SKU_CONTENTSAFETY_DEV",
    "skuContentSafetyStageProd": "SKU_CONTENTSAFETY_STAGEPROD",
    "skuVisionDev": "SKU_VISION_DEV",
    "skuVisionStageProd": "SKU_VISION_STAGEPROD",
    "skuSpeechDev": "SKU_SPEECH_DEV",
    "skuSpeechStageProd": "SKU_SPEECH_STAGEPROD",
    "skuDocIntelligenceDev": "SKU_DOCINTELLIGENCE_DEV",
    "skuDocIntelligenceStageProd": "SKU_DOCINTELLIGENCE_STAGEPROD",
    "skuBingDev": "SKU_BING_DEV",
    "skuBingStageProd": "SKU_BING_STAGEPROD",
    "skuPostgreSQLDev": "SKU_POSTGRESQL_DEV",
    "skuPostgreSQLStageProd": "SKU_POSTGRESQL_STAGEPROD",
    "skuTierPostgreSQLDev": "SKU_TIER_POSTGRESQL_DEV",
    "skuTierPostgreSQLStageProd": "SKU_TIER_POSTGRESQL_STAGEPROD",
    "skuRedisDev": "SKU_REDIS_DEV",
    "skuRedisStageProd": "SKU_REDIS_STAGEPROD",
    "skuSQLDatabaseDev": "SKU_SQLDATABASE_DEV",
    "skuSQLDatabaseStageProd": "SKU_SQLDATABASE_STAGEPROD",
    "skuTierSQLDatabaseDev": "SKU_TIER_SQLDATABASE_DEV",
    "skuTierSQLDatabaseStageProd": "SKU_TIER_SQLDATABASE_STAGEPROD",
    "skuElasticDev": "SKU_ELASTIC_DEV",
    "skuElasticStageProd": "SKU_ELASTIC_STAGEPROD",
    "skuWebAppDev": "SKU_WEBAPP_DEV",
    "skuWebAppStageProd": "SKU_WEBAPP_STAGEPROD",
    "skuTierWebAppDev": "SKU_TIER_WEBAPP_DEV",
    "skuTierWebAppStageProd": "SKU_TIER_WEBAPP_STAGEPROD",
    "skuFunctionDev": "SKU_FUNCTION_DEV",
    "skuFunctionStageProd": "SKU_FUNCTION_STAGEPROD",
    "skuTierFunctionDev": "SKU_TIER_FUNCTION_DEV",
    "skuTierFunctionStageProd": "SKU_TIER_FUNCTION_STAGEPROD",
    "skuAzureMLDev": "SKU_AZUREML_DEV",
    "skuAzureMLStageProd": "SKU_AZUREML_STAGEPROD",
    "skuTierAzureMLDev": "SKU_TIER_AZUREML_DEV",
    "skuTierAzureMLStageProd": "SKU_TIER_AZUREML_STAGEPROD",
    "skuDatabricksDev": "SKU_DATABRICKS_DEV",
    "skuDatabricksStageProd": "SKU_DATABRICKS_STAGEPROD",
    "skuLogicAppsDev": "SKU_LOGICAPPS_DEV",
    "skuLogicAppsStageProd": "SKU_LOGICAPPS_STAGEPROD",
    "skuEventHubsDev": "SKU_EVENTHUBS_DEV",
    "skuEventHubsStageProd": "SKU_EVENTHUBS_STAGEPROD",
    "skuBotServiceDev": "SKU_BOTSERVICE_DEV",
    "skuBotServiceStageProd": "SKU_BOTSERVICE_STAGEPROD",
...
DEFAULT_MISMATCH_ALLOWED = {
    ...
    "cleanFoundryCaphost",
    # AI Search maps to the shared ADMIN_AISEARCH_TIER (basic) while the
    # per-env SKU example in variables.yaml is 'standard'.
    "skuAISearchDev",
