...
sys.path.append("..")
from esmlrt.interfaces.iESMLSplitter import IESMLSplitter

## Optional: You do not need to implement/use this. Only if you want to override split behaviour
class ESMLYourSplitter(IESMLSplitter):
    def __init__(self):
        super().__init__()
