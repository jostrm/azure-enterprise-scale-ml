...
def init():
    ...
    try:
        ...
        model_name_new = '11_diabetes_model_reg'
        info_message = info_message + "02: Could not deserialize model with model_name '{}' (usually 'model.pkl'), now using custom name: '{}'.".format(model_name,model_name_new)
