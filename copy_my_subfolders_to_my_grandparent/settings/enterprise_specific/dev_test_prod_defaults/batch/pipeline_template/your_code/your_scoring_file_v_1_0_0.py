...
try:
    ...
    print("Could not IMPORT IESMLController")
...
def init():
    ...
    model_name = None
    try:
        model_name = IESMLController.get_known_model_name_pkl()
        print("Trying to deserialzie model with name with {}".format(model_name))
    except Exception as e:
        print("Could not deserialzie model with IESMLController name, now using default model.pkl")
