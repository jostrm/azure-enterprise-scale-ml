...
- Data sources: `<selected-storage>/<selected-container>/kaggle-rag-v1/knowledge/items.json` through `aif-knowledge`. See [source paths](../43-data/readme.md#data-sources-and-lake-layout).
