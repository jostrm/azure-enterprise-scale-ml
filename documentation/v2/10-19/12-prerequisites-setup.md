...
- **Mandatory:** Yes
- **TODO**:
    - 1) Azure Devops: Create a service connection, based on the service principal  `esml-common-bicep-sp` [created in step 5](#step-5-create-3-service-principals-and-store-infoappid-objectid-secret-in-the-seeding-keyvault-see-step-3)
...
### IMAGE - 2D - Select ARM Connection on a step

![](./images/12-prerequisites-ado-select-arm-con.png)
